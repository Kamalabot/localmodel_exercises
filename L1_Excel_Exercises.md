...
* **Exercise 4: Natural Language Formulas**
    * **File:** `exercise_data/L1_data/ex4_sales_status.csv`
...
* **Exercise 8: Logic Deduplication (Advanced)**
    * **File:** `exercise_data/L1_data/ex8_user_logs.csv` (Contains overlapping User IDs, Dates, and Statuses)
...
* **Exercise 9: Category Creator**
    * **File:** `exercise_data/L1_data/ex9_transactions.csv`
...
* **Exercise 10: Summary Generator**
    * **File:** `exercise_data/L1_data/ex10_11_12_sales_master.csv` (100 rows)
...
* **Exercise 11: The "What-If" Machine**
    * **File:** `exercise_data/L1_data/ex10_11_12_sales_master.csv`
...
* **Exercise 13: Bulk Email Drafter**
    * **File:** `exercise_data/L1_data/ex13_billing.csv`
...
* **Exercise 14: Data Validation**
    * **File:** `exercise_data/L1_data/ex14_validation_source.csv`
...
* **Exercise 15: The "Context Bridge"**
    * **File:** `exercise_data/L1_data/ex15_project_reference.txt` (External Doc)
    * **Task:** Open both your Excel sheet (use `exercise_data/L1_data/ex10_11_12_sales_master.csv` and add a 'Project Name' column if missing) and this text file.
