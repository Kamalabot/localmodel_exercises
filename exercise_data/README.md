# Local Model Excel Exercises - Complete Guide
...
### 3. Coding Agents (The Helpers)
* **Goal:** Use agents like **Antigravity** or **Cline** for complex file manipulations or automation scripts.
* **Action:**
    1. Ensure your workspace is open in your IDE (VS Code, etc.).
    2. Use the agent to generate boilerplate data or Python scripts for mass Excel processing.
